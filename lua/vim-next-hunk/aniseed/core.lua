local _0_0 = nil
do
  local name_0_ = "vim-next-hunk.aniseed.core"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("vim-next-hunk.aniseed.view")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {view = "vim-next-hunk.aniseed.view"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "vim-next-hunk.aniseed.core"
